...
public class MedicionFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private MedicionFragmentArgs() {
  }

  private MedicionFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static MedicionFragmentArgs fromBundle(@NonNull Bundle bundle) {
    MedicionFragmentArgs __result = new MedicionFragmentArgs();
    bundle.setClassLoader(MedicionFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    MedicionFragmentArgs that = (MedicionFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(MedicionFragmentArgs original) {
      this.arguments.putAll(original.arguments);
    }

    public Builder(@NonNull String cameraId, int pixelFormat, float tita, float b,
        @NonNull float[] h, float relacion, int ordenCero) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
    ...
    @NonNull
    public MedicionFragmentArgs build() {
      MedicionFragmentArgs result = new MedicionFragmentArgs(arguments);
      return result;
    }
